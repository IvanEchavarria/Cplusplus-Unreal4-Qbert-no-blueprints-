...
// Cross Module References
	QBERT_PROJECT_API UClass* Z_Construct_UClass_AMainGameMode_NoRegister();
	QBERT_PROJECT_API UClass* Z_Construct_UClass_AMainGameMode();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AMainGameMode()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<AMainGameMode> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(AMainGameMode, 1058401317);
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMainGameMode(Z_Construct_UClass_AMainGameMode, &AMainGameMode::StaticClass, TEXT("/Script/QBert_Project"), TEXT("AMainGameMode"), false, nullptr, nullptr, nullptr);
